    ...
    <div class="container-fluid py-3" style="padding: 0; overflow-x: hidden;">
        ...
        <main style="margin: 0; padding: 0;">
            <div class="container">
                ...
                @endif
                @if (Session::get('server_created') != null)
                    <p>Serveur créé avec succès</p>
                @endif
            </div>
            ...
            <div class="game-description" style="padding-bottom: 80px;">
                <h1 style="text-align: center;">Création d'un serveur</h1>
                <form action="{{ route('public.server.create') }}" class="row" method="POST">
                    @csrf
                    <div class="col-md-6 offset-md-3">
                        <div style="margin-bottom: 10px;">
                            <label for="max_players">Nombre de joueurs max</label>
                            <select name="max_players" id="max_players" class="form-select" aria-label="Default select example">
                        ...
                        <div style="margin-bottom: 10px;">
                            <label for="amount">Mise (Minimale 0.50€) :</label>
                            <input type="number" name="amount" id="amount" class="form-control">
                        </div>
                        <div style="margin-bottom: 10px;">
                            <label for="name">Nom de serveur :</label>
                            <input type="text" name="name" id="name" class="form-control">
                        </div>
                        <div class="buttons">
                            <a href="{{ route('public.profile') }}" class="btn btn-dark">Retour</a>
